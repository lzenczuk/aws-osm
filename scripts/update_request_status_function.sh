...
function update_function {
    ...
    aws lambda update-function-code --function-name downloadUrlStatusLambda --s3-bucket aws-osm-app --s3-key app.zip
...
aws lambda get-function --function-name downloadUrlStatusLambda
